 ...
 <div class="container">
	...
	<?php foreach ($var_select_all as $row) {?>
		...
		<div style="border:solid 1px lightgray;">
			...
			<div class="abertura">
				<?php 
					if(($row['ultima_atualizacao']) == '0000-00-00'){
						echo '<div class="label">Ultima Atualizado: </div>'." ".'00/00/0000';
					}
					else{
						echo '<div class="label">Ultima Atualizado: </div>'." ".date('d/m/Y', strtotime($row['ultima_atualizacao']));
					}
				?>
			</div>
