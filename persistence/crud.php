<?php
	require_once("../conexao/conexao.php");
 	...
 	if(($_GET['code']=='2')){ //fechamento de chamado 2
		...
		}elseif($_GET['code']==6){//cria uma nova loja
		//$loja = $pdo->prepare("inser into ");
		...
		$sql = "INSERT INTO ordem (id_loja,id_tecnico,solicitante,id_prioridade,data_abertura_chamado,ultima_atualizacao,reclamado,id_status_chamado,status)
			values(:loja,:tecnico,:solicitante,:id_priore,:data,:atualizacao,:falha,:status_chamado,:status)";
